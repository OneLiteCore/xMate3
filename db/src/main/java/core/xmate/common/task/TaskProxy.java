 ...
 * @param <ResultType>
 */
/*package*/ class TaskProxy<Params, ResultType> extends AbsTask<Params, ResultType> {
    ...
    @Override
    protected final ResultType doBackground(final Params params) throws Throwable {
        this.onWaiting();
                ...
                new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            // 执行task, 得到结果.
                            task.setResult(task.doBackground(params));
