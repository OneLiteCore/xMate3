...
public abstract class CoreAction<Raw, Result> implements Clearable {
    ...
    protected Clearable requestGet(String url) {
        return requestGet(new RequestParams(url));
    }
    
    protected Clearable requestPost(RequestParams params) {
        return request(HttpMethod.POST, params);
    }
    
    protected Clearable requestGet(RequestParams params) {
    ...
    @WorkerThread
    protected Result requestGetSync(String url) throws Throwable {
        return requestGetSync(new RequestParams(url));
    }
    
    protected Result requestPostSync(String url) throws Throwable {
        return requestPostSync(new RequestParams(url));
    }
    
    @WorkerThread
    protected Result requestGetSync(RequestParams params) throws Throwable {
        return requestSync(HttpMethod.GET, params);
    }
    
    @WorkerThread
    protected Result requestPostSync(RequestParams params) throws Throwable {
