...
/*package*/ abstract class BaseParams {
	...
	public BaseParams setCharset (String charset) {
	...
	public BaseParams setMethod (HttpMethod method) {
		this.method = method;
		return this;
	}
	...
	public BaseParams setMultipart (boolean multipart) {
	 ...
	 * @param asJsonContent
	 */
	public BaseParams setAsJsonContent (boolean asJsonContent) {
	 ...
	 * @param value
	 */
	public BaseParams setHeader (String name, String value) {
	 ...
	 * @param value
	 */
	public BaseParams addHeader (String name, String value) {
	 ...
	 */
	public BaseParams addParameter (String name, Object value) {
	 ...
	 * @param value
	 */
	public BaseParams addQueryStringParameter (String name, String value) {
		if (!TextUtils.isEmpty(name)) {
			this.queryStringParams.add(new KeyValue(name, value));
		}
		return this;
	 ...
	 * @param value
	 */
	public BaseParams addBodyParameter (String name, String value) {
		if (!TextUtils.isEmpty(name)) {
			this.bodyParams.add(new KeyValue(name, value));
		} else {
	 ...
	 * 添加body参数
	 */
	public BaseParams addBodyParameter (String name, File value) {
	 ...
	 */
	public BaseParams addBodyParameter (String name, Object value, String contentType) {
	 ...
	 */
	public BaseParams addBodyParameter (String name, Object value, String contentType, String fileName) {
	...
	public BaseParams setBodyContent (String content) {
	...
	public List<KeyValue> getAllParams () {
		List<KeyValue> result = new ArrayList<KeyValue>(queryStringParams.size() + bodyParams.size() + fileParams.size());
		result.addAll(fileParams);
		result.addAll(queryStringParams);
		result.addAll(bodyParams);
		return result;
	}
	...
	public BaseParams removeParameter (String name) {
		if (!TextUtils.isEmpty(name)) {
	...
	public BaseParams setRequestBody (RequestBody requestBody) {
